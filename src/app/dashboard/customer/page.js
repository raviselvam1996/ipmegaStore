...
export default function customerOrder() {
  ...
  const handleSubmit = async () => {
    ...
    axios
      .post("http://localhost:3000/api/customerOrder", formData)
      .then((res) => {
        console.log(res);
  ...
  const addProduct = () => {
    ...
    console.log(formData);
    axios
      .post("http://localhost:3000/api/addCutomerProduct", formData)
      .then((res) => {
  ...
  useEffect(() => {
    axios.get("http://localhost:3000/api/addProducts").then((res) => {
  ...
  return (
   ...
   {  orderProductList.length > 0 && <div className="mt-5">
